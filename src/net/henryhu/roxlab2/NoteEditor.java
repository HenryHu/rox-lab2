...
public class NoteEditor extends Activity {
    ...
    private Activity neact;
    boolean inited = false;
    boolean doResume = false;
    boolean prepareAgain = false;
    Menu savedMenu = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_EDIT.equals(action)) {
            ...
            mState = STATE_EDIT;
            mUri = intent.getData();
            pd.setTitle("Loading note...");
            pd.show();

            new InitTask().execute(action);
            ...
            pd.setTitle("Creating note...");
            pd.show();
            new NewTask().execute(intent, action);
    ...
    private class NewTask extends AsyncTask<Object, Object, Object> {
        String action;
    ...
    private class InitTask extends AsyncTask<Object, Object, Object> {
    	...
    	protected void onPostExecute(Object ret)
    	{
            ...
            if (doResume)
                onResume();
    		if (prepareAgain)
    			onPrepareOptionsMenu(savedMenu);
    	}
		...
		protected Object doInBackground(Object... params) {
            ...
            Log.i("InitTask", "uri: " + mUri + " count: " + mCursor.getCount());
    ...
    private final void performPaste() {
        ...
        if (clip != null) {
            ...
            new PasteTask().execute(item, uri, this);
        }
    }

    class PasteTask extends AsyncTask<Object, Object, Object> {
        String text = null;
        String title = null;
        Activity parent;
        ...
        public Object doInBackground(Object... params) {
            item = (ClipData.Item)params[0];
            Uri uri = (Uri)params[1];
            parent = (Activity)params[2];
            ...
            if (text == null) {
                text = item.coerceToText(parent).toString();
            }
    ...
    private final void updateNote(String text, String title) {
        ...
        new SaveTask().execute(values);
    }
    
    private class SaveTask extends AsyncTask<ContentValues, Object, Object> {
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                new UpdateTask().execute(mUri, values);
            } else if (mState == STATE_INSERT) {
    ...
    private class UpdateTask extends AsyncTask<Object, Object, Object> {
		...
		@Override
		protected Object doInBackground(Object... params) {
            getContentResolver().update((Uri)params[0], (ContentValues)params[1], null, null);
            return null;
        }
    }

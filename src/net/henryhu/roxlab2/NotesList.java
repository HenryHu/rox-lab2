...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter
            = new SimpleCursorAdapter(
                    nlact,                             // The Context for the ListView
    ...
    class UpdateTask extends AsyncTask<Object, Object, Cursor> {
        Cursor oldCursor = null;
        @Override
        protected void onPreExecute() {
            if (pd == null)
            {
                pd = new ProgressDialog(nlact);
...
/*            cursor = nlact.getContentResolver().query(
	            getIntent().getData(),            // Use the default content URI for the provider.
	            PROJECTION,                       // Return the note ID and title for each note.
	            null,                             // No where clause, return all records.
	            null,                             // No where clause, therefore no where column values.
...
/*            cursor = nlact.getContentResolver().query(
    ...
    public class MyObserver extends ContentObserver {
        ...
        {
            Log.w("MyObserver()", "Content changed!");
            if (!selfChange)
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (haveItems) {
            ...
            if (getSelectedItemId() != ListView.INVALID_ROW_ID)
            {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        case R.id.context_delete:
            ...
            new DeleteTask().execute(noteUri);
    ...
    class DeleteTask extends AsyncTask<Uri, Object, Object> {
        @Override
        protected void onPreExecute() {
            if (pd == null)
            {
        ...
        @Override
        public Object doInBackground(Uri... params)
        {
            Uri noteUri = params[0];
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
    	...
    	Log.w(TAG, "onListItemClick() id: " + id);
